...
function TableMealsManager() {
  ...
  }, [accountMenuItems, manualFoodTypeFilter, manualMenuTypeFilter, manualSearchText])
  ...
  const fillManualWithAutoRecommendation = () => {
    ...
    const recommendedResult = buildAutoTableMealsResult(accountMenuItems, selectedAutoWeek)
  ...
  const saveManualTableMeals = async () => {
    ...
    const payload = buildTableMealsSavePayload(result, selectedAutoWeek, selectedAccountId, selectedAccountName, 'manual')
  ...
  const handleAutoGenerate = async () => {
    ...
    const result = buildAutoTableMealsResult(selectedAccountMenus, selectedAutoWeek)
        ...
        <div className="table-meals-modal-backdrop table-meals-modal-backdrop--manual" role="presentation" onClick={closeManualEditor}>
          ...
          >
            <div className="table-meals-modal__header table-meals-manual-header">
              <div>
                <p className="table-meals-modal__eyebrow">Manual Meal Table</p>
                <h2 id="table-meals-manual-modal-title">수기 식단표 제작</h2>
              </div>
